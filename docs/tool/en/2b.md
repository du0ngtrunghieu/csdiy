...
第一段  
1. What is clearly illustrated in the pie chart is the remarkable contrast in the ways of residents' physical exercise in a certain city.
...
第一段
1. Given is pie chart, clearly illustrating the remarkable contrasts in students' reading purpose on mobile phones in a certain university.
